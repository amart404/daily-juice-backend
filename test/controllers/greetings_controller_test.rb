...
class GreetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create greeting" do
    assert_difference('Greeting.count') do
      post greetings_url, params: { greeting: { content: @greeting.content, vulgarity: @greeting.vulgarity } }, as: :json
    end
  ...
  test "should update greeting" do
    patch greeting_url(@greeting), params: { greeting: { content: @greeting.content, vulgarity: @greeting.vulgarity } }, as: :json
    assert_response 200
  end
